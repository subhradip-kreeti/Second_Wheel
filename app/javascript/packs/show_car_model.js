...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.querySelectorAll(".edit-car-model-btn").forEach(function (button) {
    button.addEventListener("click", function (event) {
      ...
      var editCarModelBrandSelect = document.getElementById("editCarModelBrand");
  ...
  document.getElementById("saveEditCarModel").addEventListener("click", function (event) {
    event.preventDefault();

    var editedCarModelName = document.getElementById("editCarModelName").value;
    var editedCarModelBrandId = document.getElementById("editCarModelBrand").value;
