console.log("filtereation js loaded");
window.filterCars = function () {
  ...
  var kilometerDriven = document.getElementById("kilometer-driven-select").value.trim();
  ...
  for (var i = 0; i < cards.length; i++) {
    ...
    if (
      kilometerDriven &&
      card.querySelector("#km-driven").textContent.trim() !== kilometerDriven
    ) {
      shouldDisplay = false;
    }
