...
Notification.create!([
                       { user_id: 4,
                         message: 'your appoinment for SK14BZ5789 status has been updated to Buy_Investigating', status: false },
                       { user_id: 4,
                         message: 'your appoinment for SK14BZ5789 status has been updated to Buy_Processing', status: false },
                       { user_id: 4,
                         message: 'your appoinment for WB07AZ5647 status has been updated to Buy_Processing', status: false },
                       { user_id: 2,
                         message: 'your appoinment(64KN01AX789411) status has been updated to Ready_for_Sell', status: false },
                       { user_id: 2,
                         message: 'your appoinment(64PB17DZ784515) status has been updated to Sell_Processing', status: false },
                       { user_id: 2, message: 'your appoinment(64PB17DZ784515) status has been updated to Sell_Investigating',
                         status: false },
                       { user_id: 2,
                         message: 'your appoinment(64PB17DZ784515) status has been updated to Ready_for_Sell', status: false },
                       { user_id: 5,
                         message: 'your appoinment(63SK01QT124517) status has been updated to Sell_Processing', status: false },
                       { user_id: 5, message: 'your appoinment(63SK01QT124517) status has been updated to Sell_Investigating',
                         status: false },
                       { user_id: 5,
                         message: 'your appoinment(63SK01QT124517) status has been updated to Ready_for_Sell', status: false },
                       { user_id: 5,
                         message: 'your appoinment(63UP14AX789619) status has been updated to Sell_Processing', status: false },
                       { user_id: 5,
                         message: 'your appoinment(63UP14AX789619) status has been updated to Ready_for_Sell', status: false },
                       { user_id: 5, message: 'your appoinment(63UP14AX789619) status has been updated to Sell_Investigating',
                         status: false },
                       { user_id: 4,
                         message: 'your appoinment(62GJ12AT451714) status has been updated to Buy_Processing', status: false },
                       { user_id: 4, message: 'your appoinment(62GJ12AT451714) status has been updated to Buy_Investigating',
                         status: false },
                       { user_id: 4,
                         message: 'your appoinment(62GJ12AT451714) status has been updated to Ready_to_Buy', status: false }
                     ])
